...
| `audio/kd-askawiholji.mp3` | export original recu le 2026-09-01; version publique arretee a 3:34 le 2026-09-01 | URL de generation a consigner; formule active confirmee par l'auteur; export original recuperable dans l'historique Git |
...
Les sept pochettes dans `audio/*.jpg` et les quatre scenes dans `assets/learning/*.webp` doivent chacune recevoir une fiche indiquant leur auteur ou outil de generation, leur date de creation, leur prompt ou fichier source et les conditions applicables au moment de leur creation. Jusqu'a ce que ces fiches soient completees, elles ne doivent pas etre vendues ni reutilisees hors de ce projet comme si leur provenance etait entierement documentee. La pochette `audio/kd-askawiholji.jpg` a ete generee pour ce projet le 2026-09-01 avec l'outil d'image integre de Codex; son prompt est consigne dans la tache de creation correspondante.
